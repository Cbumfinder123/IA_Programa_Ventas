...
public class VenderCeramico extends JDialog implements ActionListener {
	...
	public VenderCeramico() {
		setModal(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\trabajo\\iconos\\etiqueta-de-precio.png"));
		setTitle("Vender");
		...
		btnVender.setIcon(new ImageIcon("D:\\trabajo\\iconos\\signo-de-dolar.png"));
		btnVender.addActionListener(this);
		btnVender.setBounds(361, 7, 100, 23);
		...
		btnCerrar.setBounds(361, 32, 100, 23);
