...
public class GenerarReporte extends JDialog implements ActionListener {
	...
	void generarReporteComparacionPrecio() {
		...
		if(Tienda.precio0 < precioprom) {
			txtS.append("Comparación       : S/. " + formato1.format((Tienda.precio0 - precioprom) * -1) + " menos que el promedio\n\n");
		...
		if(Tienda.precio1 < precioprom) {
			txtS.append("Comparación       : S/. " + formato1.format((Tienda.precio1 - precioprom) * -1) + " menos que el promedio\n\n");
		...
		if(Tienda.precio2 < precioprom) {
			txtS.append("Comparación       : S/. " + formato1.format((Tienda.precio2 - precioprom) * -1) + " menos que el promedio\n\n");
		...
		if(Tienda.precio3 < precioprom) {
			txtS.append("Comparación       : S/. " + formato1.format((Tienda.precio3 - precioprom) * -1) + " menos que el promedio\n\n");
		...
		if(Tienda.precio4 < precioprom) {
			txtS.append("Comparación       : S/. " + formato1.format((Tienda.precio4 - precioprom) * -1) + " menos que el promedio\n\n");
	...
	void generarReporteComparacionCantidadOptima() {
		...
		if(Tienda.cantUniVendidas0 < Tienda.cantidadOptima) {
			txtS.append("Comparación                 : " + ((Tienda.cantUniVendidas0 - Tienda.cantidadOptima) * -1) + " menos que la cantidad óptima\n\n");
		...
		if(Tienda.cantUniVendidas1 < Tienda.cantidadOptima) {
			txtS.append("Comparación                 : " + ((Tienda.cantUniVendidas1 - Tienda.cantidadOptima) * -1) + " menos que la cantidad óptima\n\n");
		}else if(Tienda.cantUniVendidas1 > Tienda.cantidadOptima) {
			txtS.append("Comparación                 : " + (Tienda.cantUniVendidas1 - Tienda.cantidadOptima) + " más que la cantidad óptima\n\n");
		}else {
			txtS.append("Comparación                 : " +  "igual que la cantidad óptima\n\n");
		}
		...
		if(Tienda.cantUniVendidas2 < Tienda.cantidadOptima) {
			txtS.append("Comparación                 : " + ((Tienda.cantUniVendidas2 - Tienda.cantidadOptima) * -1) + " menos que la cantidad óptima\n\n");
		}else if(Tienda.cantUniVendidas2 > Tienda.cantidadOptima) {
			txtS.append("Comparación                 : " + (Tienda.cantUniVendidas2 - Tienda.cantidadOptima) + " más que la cantidad óptima\n\n");
		}else {
			txtS.append("Comparación                 : " +  "igual que la cantidad óptima\n\n");
		}
		...
		if(Tienda.cantUniVendidas3 < Tienda.cantidadOptima) {
			txtS.append("Comparación                 : " + ((Tienda.cantUniVendidas3 - Tienda.cantidadOptima) * -1) + " menos que la cantidad óptima\n\n");
		}else if(Tienda.cantUniVendidas3 > Tienda.cantidadOptima) {
			txtS.append("Comparación                 : " + (Tienda.cantUniVendidas3 - Tienda.cantidadOptima) + " más que la cantidad óptima\n\n");
		}else {
			txtS.append("Comparación                 : " +  "igual que la cantidad óptima\n\n");
		}
		...
		if(Tienda.cantUniVendidas4 < Tienda.cantidadOptima) {
			txtS.append("Comparación                 : " + ((Tienda.cantUniVendidas4 - Tienda.cantidadOptima) * -1) + " menos que la cantidad óptima\n\n");
		}else if(Tienda.cantUniVendidas4 > Tienda.cantidadOptima) {
			txtS.append("Comparación                 : " + (Tienda.cantUniVendidas4 - Tienda.cantidadOptima) + " más que la cantidad óptima\n\n");
		}else {
			txtS.append("Comparación                 : " +  "igual que la cantidad óptima\n\n");
		}
