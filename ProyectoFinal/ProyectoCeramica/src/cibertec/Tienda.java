...
public class Tienda extends JFrame implements ActionListener {
	 ...
	 */
	public Tienda() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\trabajo\\iconos\\titulo.png"));
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\trabajo\\iconos\\Vent (1) (1).jpg"));
		lblNewLabel.setBounds(0, 0, 1918, 985);
